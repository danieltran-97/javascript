...
//   console.log(`Race number ${raceNumber} our race will start at 9:30 am.`);
// } else if ((runnersAge => 18) && !(raceNumber => 1000)) {
//   console.log(`Race number ${raceNumber} our race will start at 11:00 am.`);
// } else if (runnersAge < 18) {
//   console.log(`Race number ${raceNumber} our race will start at 12:30 pm.`);
// }
